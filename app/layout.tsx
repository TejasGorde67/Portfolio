...
export const metadata: Metadata = {
  title: "Tejas Gorde - Full Stack Developer | Portfolio",
  description:
  ...
  authors: [{ name: "Tejas Gorde" }],
  creator: "Tejas Gorde",
  publisher: "Tejas Gorde",
  generator: "Next.js",
  applicationName: "Tejas Gorde Portfolio",
  ...
  openGraph: {
    ...
    siteName: "Tejas Gorde Portfolio",
    title: "Tejas Gorde - Full Stack Developer",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Tejas Gorde - Full Stack Developer Portfolio",
      },
    ],
  },
  twitter: {
  ...
  other: {
    ...
    "og:image:alt": "Tejas Gorde - Full Stack Developer Portfolio",
    "og:site_name": "Tejas Gorde Portfolio",
    "og:locale": "en_US",
    "og:type": "website",
    "og:url": "https://bhanupratap.dev",
    "og:title": "Tejas Gorde - Full Stack Developer",
    "og:description":
      "A 20 year-old Full Stack Developer from India who loves building efficient, scalable, and intuitive applications. Currently working as Founding Engineer at a stealth startup.",
    "og:image": "https://iili.io/KB9qfG1.png",
    "twitter:image:alt": "Tejas Gorde - Full Stack Developer Portfolio",
    "twitter:domain": "bhanupratap.dev",
    "twitter:url": "https://bhanupratap.dev",
    "whatsapp:image": "https://iili.io/KB9qfG1.png",
    "whatsapp:title": "Tejas Gorde - Full Stack Developer",
